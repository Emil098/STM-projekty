...
/* USER CODE BEGIN Header_StartLraGyroTask */
/**
* @brief Function implementing the LraGyroTask thread.
* @param argument: Not used
* @retval None
*/
...
void StartLraGyroTask(void const * argument)
{
  ...
  /* USER CODE END StartLraGyroTask */
}
