...
KEEP extern const touchgfx::KerningNode kerning_times_30_4bpp[] FONT_KERNING_LOCATION_FLASH_ATTRIBUTE = {
    ...
    { 0x0056, -1 },  // (First char = [0x0056, V], Second char = [0x0020,  ], Kerning dist = -1)
    { 0x0057, -1 },  // (First char = [0x0057, W], Second char = [0x0020,  ], Kerning dist = -1)
    ...
    { 0x0020, -1 },  // (First char = [0x0020,  ], Second char = [0x0056, V], Kerning dist = -1)
    ...
    { 0x0020, -1 },  // (First char = [0x0020,  ], Second char = [0x0057, W], Kerning dist = -1)
